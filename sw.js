const CACHE_NAME = 'pwa-demo-ebook-digital-cache-v1',
  urlsToCache = [
    './',
    './?utm=homescreen',
    './index.html',
...
self.addEventListener('push', e => {
  ...
  let title = 'Push Notificación Demo',
    options = {
      ...
      data: { id: 1 },
      actions: [
        { 'action': 'Si', 'title': 'Amo esta aplicación :)', icon: './images/twitter.png'},
        { 'action': 'No', 'title': 'No me gusta esta aplicación :(', icon: './images/twitter.png' }
      ]
    }
